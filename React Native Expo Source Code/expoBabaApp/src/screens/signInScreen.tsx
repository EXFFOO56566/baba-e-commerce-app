...
const LoginScreen = ({ navigation, theme, reduxLang }: IProps) => {
  // Header Settings
  useLayoutEffect(() => {
      ...
      <ScrollView
        ...
        <View style={styles.forgotRow}>
          ...
          <View style={styles.rememberMeVIew}>
            <TouchableOpacity style={styles.forgotText} onPress={() => onChangeCheckBox(!checkBox)}>
              <Ionicons
          ...
          <TouchableOpacity style={styles.forgotText}>
            <Text style={{
              fontSize: theme.appFontSize.smallSize,
              fontFamily: theme.appFontSize.fontFamily, color: theme.textColor
            }}>{reduxLang.ForgotPassword}</Text>
          </TouchableOpacity>
        </View>
        <CustomBtn onPressFun={() => { }} theme={theme} title={reduxLang.SignIn}></CustomBtn>
        ...
        <View style={styles.signUpContainer}>
          <Text style={{
            ...
            fontSize: theme.appFontSize.smallSize,
            fontFamily: theme.appFontSize.fontFamily,
          }}>{reduxLang.DontHaveAnAccount}</Text>
          <TouchableOpacity onPress={() =>
