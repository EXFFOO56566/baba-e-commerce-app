...
import { RootHomeStackParamList } from './RootParams';

const Stack = createStackNavigator<RootHomeStackParamList>();
...
function MyTabsStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="RatingReviewsScreen" component={RatingReviewsScreen} />
      <Stack.Screen name="CustomizeTheme" component={CustomizeThemeScreen} />
      <Stack.Screen name="Category" options={{headerShown: true}} component={Category} />
      ...
      <Stack.Screen name="IntroSliderScreen" options={() => {
          return {
            tabBarVisible: false,
            headerShown: false,
          };
