...
const header = (theme: appColorsType,
  navigation: StackNavigationProp<RootStackParamList>,
  reduxLang: any, gridView: boolean,
  setGridView: (value: boolean) => void,
  setModalVisibleSortBy: (Value: boolean) => void,
  ...
  <View style={[styles.searchContainerView, {
    ...
    <View style={[styles.headerRow]}>
      ...
      <TouchableOpacity style={[styles.horiPadding,
      ...
      <TouchableOpacity style={[styles.horiPadding, styles.sortByIconText]}
...
const App = ({ navigation, theme, reduxLang,
  ...
  const [statusBarStyle, setStatusBarStyle] = useState<any>('light-content');
  ...
  return (
    ...
    >
      ...
      {/* //Search Header */}
      { header(theme, navigation, reduxLang, gridView, setGridView, setModalVisibleSortBy, recentTextArray, setModalVisible, route.name)}
        ...
        <FlatList
          ...
          renderItem={item => (
            <TouchableOpacity
              ...
              style={[styles.selectedTabStyles, { backgroundColor: theme.primary }]}>

              <Text style={[styles.horiCategoryText, {
                color: selectedTab === item.index ? theme.primaryTextColor : theme.primaryDark,
                fontSize: theme.appFontSize.largeSize,
                fontFamily: theme.appFontSize.fontFamily,
              ...
              {selectedTab === item.index ?
                <View style={[styles.selectedBorder, { backgroundColor: theme.primaryTextColor }]} /> : <View />}
            </TouchableOpacity>
