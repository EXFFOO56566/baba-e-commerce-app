...
import { CategoryStackParamList } from '../router/RootParams';
...
const CategorySelection = (theme: appColorsType, value: string,
  setcategoryType: (type: string) => void, categoryTypeValue: string) => (
  <TouchableOpacity
    onPress={() => setcategoryType(value)}
  >
    <Text style={[styles.categorySelection, {
      color: categoryTypeValue === value ?
        theme.primary :
        theme.textColor,
...
const App = ({ navigation, theme, reduxLang }: IProps) => {
  ...
  const [array2] = React.useState([{
    url:
      require('../images/Categories/Menright.png'),
  ...
  return (
    <SafeAreaView
      ...
      {categoryType === '6' ?
        <CategorySix data={array} headPhones={headPhones}
          mensData={mensData} groceryData={groceryData} subCategory={furniture} theme={theme} reduxLang={reduxLang} />
         : categoryType === '10' ?
          <CategoryTenth data={array} headPhones={headPhones}
            mensData={mensData} groceryData={groceryData} subCategory={furniture} theme={theme} reduxLang={reduxLang} />
         :
        <ScrollView
          ...
          {categoryType === '1' ?
            <CategoryOne data={array2} theme={theme} reduxLang={reduxLang} />
            : null}
          {categoryType === '2' ?
            <CategoryTwo data={array3} theme={theme} />
            : null}
          {categoryType === '3' ?
            <CategoryThree data={array} theme={theme} reduxLang={reduxLang} />
            : null}
          {categoryType === '4' ?
