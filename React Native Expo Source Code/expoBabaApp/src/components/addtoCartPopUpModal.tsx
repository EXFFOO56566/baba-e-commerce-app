  ...
  return (
    <View>
      ...
      <Modal
        ...
        <TouchableWithoutFeedback onPress={() => setaddtoCartModalVisible(!addtoCartmodalVisible)}>
        ...
        <View style={[styles.modalView, {
          ...
          <CustomBtn onPressFun={() => setaddtoCartModalVisible(!addtoCartmodalVisible)} theme={theme} title={reduxLang.addToCart}></CustomBtn>
        </View>
