...
interface IProps {
  data: { url: string, productName: string, quantity: string };
  productDetailData: { url: string, productName: string, quantity: string }[];
  theme: appColorsType;
  addToCartFun: () => void;
  backgroundColor?: string;
  index: number;
  whishlistTrash?: boolean;
  cardStyle?: number;
  reduxLang?: any;
}
const card = ({ data, theme, addToCartFun,
  index, whishlistTrash, cardStyle, productDetailData, reduxLang }: IProps) => {
