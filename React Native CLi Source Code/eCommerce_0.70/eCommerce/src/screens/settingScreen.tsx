...
import { HEIGHT, HEADER_IOS_HEIGHT, HEADER_ANDROID_HEIGHT } from '../components/config';
...
function SettingScreen({
  ...
  function selectThemeMode(index: number) {
    ...
    <View
      ...
      <Animated.ScrollView
        ...
        <LinearGradient
          ...
          colors={!I18nManager.isRTL ? [theme.primary, theme.primaryLight] : [theme.primaryLight, theme.primary]}
          ...
          <Text style={[styles.nameText, {
                ...
                paddingTop: Platform.OS === 'ios' ? HEIGHT * 0.12 :
                HEIGHT * 0.1
              }]}>
                {reduxLang['Settings']}
              </Text>
        ...
        <View style={styles.gSettingTextView}>
          <Text
            style={[
              styles.settingText,
              {
                color: theme.textColor, fontSize: theme.appFontSize.largeSize + 2,
                fontFamily: theme.appFontSize.fontFamily,
              },
            ]}>
...
const styles = StyleSheet.create({
  ...
  drawerImageStyle: {
    ...
    height: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.22 :
      HEADER_ANDROID_HEIGHT * 0.35,
    width: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.22 :
      HEADER_ANDROID_HEIGHT * 0.35,
  ...
  userImageStyle: {
    padding: 10,
    height: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.7 :
      HEADER_ANDROID_HEIGHT * 1,
    width: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.7 :
      HEADER_ANDROID_HEIGHT * 1,
  },
  emailText: {
    textAlign: 'center',
  ...
  listLabelView: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    padding: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.13 :
      HEADER_ANDROID_HEIGHT * 0.23,
    paddingLeft: 20,
    paddingRight: 20,
    alignItems: 'center',
    margin: 0,
    marginVertical: Platform.OS === 'ios' ? HEADER_IOS_HEIGHT * 0.012 :
