...
const ProductDetailScreen = ({ navigation, theme, reduxLang, route }: IProps) => {

  const { dataImages } = route.params;
  ...
  let [data, setdata] = useState(dataImages)
  ...
  const headerFun = (text: string) => (
    <View
      ...
      <FontAwesome name={!I18nManager.isRTL ? 'chevron-right' : 'chevron-left'} style={[styles.paddingHot, {
    ...
    >
      ...
      <SafeAreaView style={styles.btnsContainer}>
        <CustomBtn
          ...
          backgroundColor={theme.secondryBackgroundColor}
          borderRadius={1} width={WIDTH * 0.5} onPressFun={() => {
            setaddtoCartModalVisible(!addtoCartmodalVisible)
          }} theme={theme} title={reduxLang.ADDTOCART}></CustomBtn>

        <CustomBtn borderRadius={1} width={WIDTH * 0.5} onPressFun={() => {
          setaddtoCartModalVisible(!addtoCartmodalVisible)
        }} theme={theme} title={reduxLang.BUYNOW}></CustomBtn>
      </SafeAreaView>
      ...
      <Animated.View
        ...
        <View style={styles.flexDir}>
          ...
          >
            <Ionicons
              style={[styles.headerIconTouchableHeart,
              {
                color: theme.primaryTextColor,
        ...
        ListHeaderComponent={
          ...
          <View style={{ paddingBottom: 3 }}>
            ...
            <LinearGradient
              ...
              colors={!I18nManager.isRTL ? [theme.primary, theme.primaryLight] : [theme.primaryLight, theme.primary]}              style={styles.flashRow}>
            ...
            <View style={[styles.priceContainer, { backgroundColor: theme.secondryBackgroundColor }]}>
            ...
            <TouchableOpacity onPress={() => setaddtoCartModalVisible(!addtoCartmodalVisible)}>
            ...
            <TouchableOpacity
              ...
              style={[styles.reviewsSectionView, {
                backgroundColor: theme.secondryBackgroundColor
              }]}>
              ...
              <View style={styles.customerDataView}>
                <Image source={require('../images/maleAvatar.png')}
                  resizeMode={'cover'}
